...
describe('scrapeResultSchema', () => {
  it('accepts a well-formed merged result', () => {
    const ok = {
      ...
      price: { currentPrice: 100, change: 1, changePercent: 1, volume: 1000, high: 101, low: 99, open: 99, close: 100, marketCap: 1e9, week52High: 120, week52Low: 80, lastTradeDate: new Date().toISOString() },
